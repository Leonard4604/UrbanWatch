...
def submit_notification():
    ...
    notification = Notification.query.filter_by(email=email, firstName=firstName, lastName=lastName, title=title, category=category).first()
    ...
    new_notification = Notification(email=email, firstName=firstName, lastName=lastName, title=title, category=category)
